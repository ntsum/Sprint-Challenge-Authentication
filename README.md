...
Sessions allow data to persist across a request. It stores data on the server side and abstracts the sending and receiving of cookies. This can allow for a user to be logged into a bank account and view their information for x amount of time, and once it runs out your session will end, where you may need to log back into an account. 
___________________________________________________________________
1. What does bcrypt do to help us store passwords in a secure manner.
bcrypt helps us store passwords in a secure manner by hashing the users password and then storing in that hashed form. This way you are no longer able to view a users password and therefore making it more secure. 
___________________________________________________________________
1. What does bcrypt do to slow down attackers?
Slow key changing is beneficial to password hashing methods such as bcrypt since the extra computational demand helps protect against dictionary and brute force attacks by slowing down the attack.
___________________________________________________________________
1. What are the three parts of the JSON Web Token?
The three parts to a JSON web token are Header, secret and payload. 
___________________________________________________________________
## Project Set Up
